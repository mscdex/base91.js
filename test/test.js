...
assert.deepEqual(base91.encode('node.js rules!').toString(), 'lref5gTT$FQ;C90ohA');
...
assert.deepEqual(base91.encode(buf).toString(), ':C#(:C?hVB$MSiVEwndBAMZRxwFfBB;IW<}YQVH`H');
